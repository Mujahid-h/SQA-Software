...
//   return (
//     <div className="bg-white shadow-md rounded-lg p-4  mt-20 border border-gray-200 mx-4 lg:mx-12">
...
//           onChange={handleChange}
//           className="flex-grow w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-300"
//         >
